...
public class Activity10_3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        dragAndDropAction.dragAndDrop(ball, drop1).build().perform();
        ...
        System.out.println("After dropping ball to Dropzone1, Text updated to:"+ drop1.getText());

        // Repeat for the second dropzone
        dragAndDropAction.dragAndDrop(ball, drop2).build().perform();
        wait.until(ExpectedConditions.attributeToBeNotEmpty(drop2, "background-color"));
        System.out.println("ENTERED DROPZONE 2");
        System.out.println("After dropping ball to Dropzone2, Text updated to:"+ drop2.getText());
